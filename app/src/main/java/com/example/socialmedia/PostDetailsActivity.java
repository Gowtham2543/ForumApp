...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    private void loadComments() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Posts").child(postId).child("Comments");
    ...
    private void setLikes() {
        final DatabaseReference liekeref = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Likes");
    ...
    private void likepost() {
        ...
        mlike = true;
        final DatabaseReference liekeref = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Likes");
        final DatabaseReference postref = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("Posts");
        liekeref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void postComment() {
        ...
        DatabaseReference datarf = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Posts").child(postId).child("Comments");
    ...
    private void updatecommetcount() {
        count = true;
        final DatabaseReference reference = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Posts").child(postId);
    ...
    private void loadUserInfo() {
        ...
        Query myref = FirebaseDatabase.getInstance("https://social-media-d83ed-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Users");
